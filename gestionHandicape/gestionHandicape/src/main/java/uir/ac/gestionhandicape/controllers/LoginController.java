...
public class LoginController {
    ...
    private boolean authenticate(String email, String password) {
        uir.ac.gestionhandicape.service.CompteService compteService = new uir.ac.gestionhandicape.service.CompteService();
        return compteService.connecter(email, password);
    }
